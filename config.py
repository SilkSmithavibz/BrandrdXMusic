...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Silksmitha X Music")
...
OWNER_ID = int(getenv("OWNER_ID", "6861555754"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/SilkSmithavibz/BrandrdXMusic",
)
...
SERVER_PLAYLIST_LIMIT = int(getenv("SERVER_PLAYLIST_LIMIT", "550"))
